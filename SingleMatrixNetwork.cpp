...
int main(int argc, char* argv[])
{
	...
	Network DynamicsTest("SingleUnit3.txt");
//	Network DynamicTest(1, 2, 2, "SingleUnit3.txt")
	...
	while (i < total_time_step) {
		...
		DynamicsTest.writeNetworkSquashedOutputStateToFile("SampleSquashed35.txt");


		DynamicsTest.writeNetworkOutputStateToFile("SampleTest35.txt");
